...
x01 = [pendant_length, pendant_length, pendant_length, pendant_length, 0.101]
...
if calculate:
    ...
    pendants = np.linspace(0.3224, 0.3228, 5)
    interiors = np.linspace(0, 0.000001, 4)
...
plt.title(r"$F'(\lambda_{\mathrm{pen}}, \lambda_{\mathrm{int}})$")
